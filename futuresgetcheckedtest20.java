...
public class FuturesGetCheckedTestTest20 extends TestCase {
    ...
    public void testGetCheckedTimed_runtimeException() throws TwoArgConstructorException {
        RuntimeException expected = assertThrows(RuntimeException.class, () -> getChecked(RUNTIME_EXCEPTION_FUTURE, TwoArgConstructorException.class, 0, SECONDS));
