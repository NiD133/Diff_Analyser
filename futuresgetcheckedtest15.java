...
public class FuturesGetCheckedTestTest15 extends TestCase {
    ...
    public void testGetCheckedTimed_cancelled() throws TwoArgConstructorException {
        ...
        future.cancel(true);
        assertThrows(CancellationException.class, () -> getChecked(future, TwoArgConstructorException.class, 0, SECONDS));
    }
}
