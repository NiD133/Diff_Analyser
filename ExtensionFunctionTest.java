...
class ExtensionFunctionTest extends AbstractJXPathTest {
    ...
    @Test
    void testFullyQualifiedConstructor() {
    ...
    @Test
    void testCollectionReturnPointer() {
        assertXPathPointerIterator(context, "test:collection()/name", list("/.[1]/name", "/.[2]/name"));
    }

    @Test
    void testCollectionReturnValue() {
        assertXPathValue(context, "test:collection()/name", "foo");
    }

    @Test
    void testCollectionReturnValueAttribute() {
        assertXPathValue(context, "test:collection()/@name", "foo");
    }

    @Test
    void testCustomCollectionReturn() {
    ...
    @Test
    void testStaticMethodCallWithPackageFunctions() {
    ...
    @Test
    void testStaticMethodCallWithFullyQualifiedClass() {
    ...
    @Test
    void testStaticMethodCallWithOverloadedFunction() {
    ...
    // Section: Establish NodeSet baseline tests
    @Test
    ...
    // Section: Expression context tests
    @Test
    ...
    @Test
    void testExpressionContextWithCollection() {
    ...
    @Test
    void testExpressionContextWithStrings() {
    ...
    @Test
    void testExpressionContextWithPointers() {
    ...
    @Test
    void testExpressionContextWithPath() {
        // The function uses ExpressionContext to get to the current
