...
/**
 * Tests for extension functions in JXPath.
 *
 * <p>This class tests various aspects of extension functions, including:
 * <ul>
 *   <li>Calling static and instance methods as functions.</li>
 *   <li>Creating new objects using constructors exposed as functions.</li>
 *   <li>Passing different types of arguments to functions, including type conversion.</li>
 *   <li>Returning different types of values from functions, including NodeSets and Collections.</li>
 *   <li>Using ExpressionContext within functions to access the current node.</li>
 * </ul>
 */
class ExtensionFunctionTest extends AbstractJXPathTest {

    /**
     * A simple implementation of ExpressionContext for testing purposes.
     */
    private static final class Context implements ExpressionContext {

        private final Object object;

        Context(final Object object) {
            this.object = object;
        }
    ...
    public void setUp() {
        if (context == null) {
            // Create a test bean and a JXPathContext
            testBean = new TestBean();
            context = JXPathContext.newContext(testBean);

            // Declare a variable that holds a TestFunctions instance
            final Variables vars = context.getVariables();
            vars.declareVariable("test", new TestFunctions(4, "test"));

            // Create a FunctionLibrary and register functions
            ...
            lib.addFunctions(new PackageFunctions("", null)); // Package functions with no prefix
            context.setFunctions(lib);

            // Declare variables for List and NodeSet classes
    ...
    @Test
    void testAllocation() {
        // Test object allocation using extension functions

        // Allocate a new object using the default constructor
        assertXPathValue(context, "string(test:new())", "foo=0; bar=null");

        // Allocate a new object using PackageFunctions and class name
        assertXPathValue(context, "string(jxpathtest:TestFunctions.new())", "foo=0; bar=null");

        // Allocate a new object using a fully qualified class name
        assertXPathValue(context, "string(" + TestFunctions.class.getName() + ".new())", "foo=0; bar=null");

        // Allocate a new object using a custom constructor
        assertXPathValue(context, "string(test:new(3, 'baz'))", "foo=3; bar=baz");

        // Allocate a new object using a custom constructor - type conversion
        assertXPathValue(context, "string(test:new('3', 4))", "foo=3; bar=4.0");

        // Allocate a new object using a custom constructor with a variable
    ...
    void testBCNodeSetHack() {
        // Tests a workaround for backward compatibility related to NodeSets
    ...
    void testCollectionMethodCall() {
        // Tests calling methods on collections through JXPath
        ...
        // Add an element to the list using JXPath
        context.getValue("add($myList, 'hello')");
        assertEquals(2, list.size(), "After adding an element");

        // Call an extension function on root collection
    ...
    void testCollectionReturn() {
        // Tests returning collections from extension functions

        // Test returning a collection of strings
        ...
        // Test returning a list of items
        final List list = new ArrayList();
        list.add("foo");
        list.add("bar");
    ...
    void testConstructorLookup() {
        // Tests looking up a constructor based on argument types
    ...
    void testConstructorLookupWithExpressionContext() {
        // Tests looking up a constructor when an ExpressionContext is available
    ...
    void testEstablishNodeSetBaseline() {
        // Establishes baseline behavior regarding NodeSets
    ...
    void testExpressionContext() {
        // Tests the use of ExpressionContext within extension functions
        ...
        // The function gets all nodes in the context that match the pattern.
    ...
    @Test
    void testMethodCall() {
        // Tests calling instance methods as extension functions

        // Call a standard Java method
    ...
    void testMethodLookup() {
        // Tests looking up an instance method based on argument types
    ...
    void testMethodLookupWithExpressionContext() {
        // Tests looking up an instance method when an ExpressionContext is available
        final Object[] args = { new TestFunctions() };
    ...
    void testMethodLookupWithExpressionContextAndArgument() {
        // Tests looking up an instance method with ExpressionContext and an argument
        final Object[] args = { new TestFunctions(), "*" };
    ...
    void testNodeSetReturn() {
        // Tests returning NodeSets from extension functions

        // Test returning a NodeSet of names
    ...
    void testStaticMethodCall() {
        // Tests calling static methods as extension functions
    ...
    void testStaticMethodLookup() {
        // Tests looking up a static method based on argument types
        final Object[] args = { Integer.valueOf(1), "x" };
    ...
    void testStaticMethodLookupWithConversion() {
        // Tests looking up a static method with type conversion of arguments
    ...
    void testStaticMethodLookupWithExpressionContext() {
        // Tests looking up a static method when an ExpressionContext is available
        final Object[] args = {};
