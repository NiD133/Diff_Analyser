...
import org.junit.jupiter.api.Deprecated;
...
class RandomUtilsTest extends AbstractLangTest {
    ...
    class BooleanTest {
        ...
        void shouldReturnBoolean(final RandomUtils ru) {
            // This is a smoke test to ensure the method executes without exceptions.
            // The actual result is non-deterministic and not asserted.
            ru.randomBoolean();
        }
    }
    ...
    class BytesTest {
        @ParameterizedTest
        @MethodSource("org.apache.commons.lang3.RandomUtilsTest#randomProvider")
        void shouldReturnByteArrayOfCorrectSize(final RandomUtils ru) {
    ...
    class DoubleTest {
        @ParameterizedTest
        @MethodSource("org.apache.commons.lang3.RandomUtilsTest#randomProvider")
        void shouldReturnPositiveDoubleInDefaultRange(final RandomUtils ru) {
        ...
        @ParameterizedTest
        @MethodSource("org.apache.commons.lang3.RandomUtilsTest#randomProvider")
        void shouldReturnDoubleWithinExtremeRange(final RandomUtils ru) {
    ...
    class FloatTest {
        @ParameterizedTest
        @MethodSource("org.apache.commons.lang3.RandomUtilsTest#randomProvider")
        void shouldReturnPositiveFloatInDefaultRange(final RandomUtils ru) {
        ...
        @ParameterizedTest
        @MethodSource("org.apache.commons.lang3.RandomUtilsTest#randomProvider")
        void shouldReturnFloatWithinExtremeRange(final RandomUtils ru) {
    ...
    class IntTest {
        @ParameterizedTest
        @MethodSource("org.apache.commons.lang3.RandomUtilsTest#randomProvider")
        void shouldReturnPositiveIntInDefaultRange(final RandomUtils ru) {
        ...
        @ParameterizedTest
        @MethodSource("org.apache.commons.lang3.RandomUtilsTest#randomProvider")
        void shouldReturnIntWithinExtremeRange(final RandomUtils ru) {
    ...
    class LongTest {
        @ParameterizedTest
        @MethodSource("org.apache.commons.lang3.RandomUtilsTest#randomProvider")
        void shouldReturnPositiveLongInDefaultRange(final RandomUtils ru) {
        ...
        @ParameterizedTest
        @MethodSource("org.apache.commons.lang3.RandomUtilsTest#randomProvider")
        void shouldReturnLongWithinExtremeRange(final RandomUtils ru) {
        ...
        @ParameterizedTest
        @MethodSource("org.apache.commons.lang3.RandomUtilsTest#randomProvider")
        void shouldAdhereToEndExclusiveBoundForLargeLongRange(final RandomUtils ru) {
            final long startInclusive = 12900000000001L;
            final long endExclusive = 12900000000016L;
            // The previous buggy implementation using 'return (long) nextDouble(start, end)'
            // fails this test frequently, as it can return the endExclusive value.
            ...
            for (int i = 0; i < iterations; i++) {
                ...
                assertNotEquals(endExclusive, result, "Result should not be equal to endExclusive");
            }
        }
    }
