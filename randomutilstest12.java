...
class RandomUtilsTest {
    ...
    class RandomBooleanTest {
        ...
        void shouldReturnBooleanValue(final RandomUtils ru) {
            ...
            // This is a tautology, but it confirms a boolean is returned without exceptions.
    ...
    class RandomDoubleTest {
        ...
        void shouldGenerateValueWithinGivenRange(final RandomUtils ru) {
            ...
            assertTrue(result >= 33d, "Result should be within the lower bound (inclusive)");
            assertTrue(result < 42d, "Result should be within the upper bound (exclusive)");
        }

        @ParameterizedTest
        @MethodSource("org.apache.commons.lang3.RandomUtilsTest#randomProvider")
        void shouldReturnStartInclusiveWhenRangeIsZero(final RandomUtils ru) {
    ...
    class RandomFloatTest {
        ...
        void shouldGenerateValueWithinGivenRange(final RandomUtils ru) {
            ...
            assertTrue(result >= 33f, "Result should be within the lower bound (inclusive)");
            assertTrue(result < 42f, "Result should be within the upper bound (exclusive)");
        }
    ...
    class RandomIntTest {
        ...
        void shouldGenerateValueWithinGivenRange(final RandomUtils ru) {
            ...
            assertTrue(result >= 33, "Result should be within the lower bound (inclusive)");
            assertTrue(result < 42, "Result should be within the upper bound (exclusive)");
        }
    ...
    class RandomLongTest {
        ...
        void shouldGenerateValueWithinGivenRange(final RandomUtils ru) {
            ...
            assertTrue(result >= 33L, "Result should be within the lower bound (inclusive)");
            assertTrue(result < 42L, "Result should be within the upper bound (exclusive)");
        }
        ...
        @ParameterizedTest
        @MethodSource("org.apache.commons.lang3.RandomUtilsTest#randomProvider")
        void shouldNotGenerateEndExclusiveForLargeValueRange_LANG_1592(final RandomUtils ru) {
            final long startInclusive = 12900000000001L;
            final long endExclusive = 12900000000016L;
            // The previous buggy method failed frequently with a loop of this size.
