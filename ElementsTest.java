...
public class ElementsTest {
    ...
    @Test
    public void validateHasAttributeMethod() {
    ...
    @Test
    public void validateHasAbsoluteAttributeMethod() {
    ...
    @Test
    public void testAbsoluteAttributeMethod() {
        Document doc = Jsoup.parse("<a id='1' href='/foo'>One</a> <a id='2' href='https://jsoup.org'>Two</a>");
        Elements one = doc.select("#1");
        Elements two = doc.select("#2");
        Elements both = doc.select("a");
    ...
    @Test
    public void validateHasClassCaseInsensitiveMethod() {
    ...
    @Test
    public void validateHasTextMethod() {
    ...
    @Test
    public void testOuterHtmlMethod() {
        Document doc = Jsoup.parse("<div><p>Hello</p></div><div><p>There</p></div>");
        Elements divs = doc.select("div");
    ...
    @Test
    public void testTagNameSetMethod() {
    ...
    @Test
    public void testCommentsMethod() {
    ...
    @Test
    public void testTextNodesMethod() {
    ...
    @Test
    public void testDataNodesMethod() {
