...
public class MultiFilteredRenderListenerTestTest1 {
    ...
    public void test() throws IOException {
        ...
        for (int i = 0; i < regions.length; i++) extractionStrategies[i] = (LocationTextExtractionStrategy) listener.attachRenderListener(new LocationTextExtractionStrategy(), regionFilters[i]);
