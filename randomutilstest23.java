...
class RandomUtilsTest extends AbstractLangTest {
    ...
    class RandomBooleanTests {
        ...
        void randomBoolean_shouldReturnBooleanValue(final RandomUtils ru) {
            final boolean result = ru.randomBoolean();
            // This is a tautology, but it confirms the method returns a valid boolean.
            assertTrue(result || !result);
        }
    }

    @Nested
    @DisplayName("randomBytes() Tests")
    class RandomBytesTests {
        @ParameterizedTest
        @MethodSource("org.apache.commons.lang3.RandomUtilsTest#randomProvider")
        void randomBytes_shouldReturnArrayOfCorrectLength(final RandomUtils ru) {
    ...
    @Nested
    @DisplayName("randomDouble() Tests")
    class RandomDoubleTests {
        @ParameterizedTest
        @MethodSource("org.apache.commons.lang3.RandomUtilsTest#randomProvider")
        void randomDouble_noArgs_shouldReturnPositiveValue(final RandomUtils ru) {
        ...
        @ParameterizedTest
        @MethodSource("org.apache.commons.lang3.RandomUtilsTest#randomProvider")
        void randomDouble_withRange_shouldReturnValuewithinBounds(final RandomUtils ru) {
        ...
        @ParameterizedTest
        @MethodSource("org.apache.commons.lang3.RandomUtilsTest#randomProvider")
        void randomDouble_withExtremeRange_shouldReturnValuewithinBounds(final RandomUtils ru) {
    ...
    @Nested
    @DisplayName("randomFloat() Tests")
    class RandomFloatTests {
        @ParameterizedTest
        @MethodSource("org.apache.commons.lang3.RandomUtilsTest#randomProvider")
        void randomFloat_noArgs_shouldReturnPositiveValue(final RandomUtils ru) {
        ...
        @ParameterizedTest
        @MethodSource("org.apache.commons.lang3.RandomUtilsTest#randomProvider")
        void randomFloat_withRange_shouldReturnValuewithinBounds(final RandomUtils ru) {
        ...
        @ParameterizedTest
        @MethodSource("org.apache.commons.lang3.RandomUtilsTest#randomProvider")
        void randomFloat_withExtremeRange_shouldReturnValuewithinBounds(final RandomUtils ru) {
    ...
    @Nested
    @DisplayName("randomInt() Tests")
    class RandomIntTests {
        @ParameterizedTest
        @MethodSource("org.apache.commons.lang3.RandomUtilsTest#randomProvider")
        void randomInt_noArgs_shouldReturnPositiveValue(final RandomUtils ru) {
        ...
        @ParameterizedTest
        @MethodSource("org.apache.commons.lang3.RandomUtilsTest#randomProvider")
        void randomInt_withRange_shouldReturnValuewithinBounds(final RandomUtils ru) {
        ...
        @ParameterizedTest
        @MethodSource("org.apache.commons.lang3.RandomUtilsTest#randomProvider")
        void randomInt_withExtremeRange_shouldReturnValuewithinBounds(final RandomUtils ru) {
    ...
    @Nested
    @DisplayName("randomLong() Tests")
    class RandomLongTests {
        @ParameterizedTest
        @MethodSource("org.apache.commons.lang3.RandomUtilsTest#randomProvider")
        void randomLong_noArgs_shouldReturnPositiveValue(final RandomUtils ru) {
        ...
        @ParameterizedTest
        @MethodSource("org.apache.commons.lang3.RandomUtilsTest#randomProvider")
        void randomLong_withRange_shouldReturnValuewithinBounds(final RandomUtils ru) {
        ...
        @ParameterizedTest
        @MethodSource("org.apache.commons.lang3.RandomUtilsTest#randomProvider")
        void randomLong_withExtremeRange_shouldReturnValuewithinBounds(final RandomUtils ru) {
