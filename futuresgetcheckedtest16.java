...
public class FuturesGetCheckedTestTest16 extends TestCase {
    ...
    public void testGetCheckedTimed_executionExceptionChecked() {
        TwoArgConstructorException expected = assertThrows(TwoArgConstructorException.class, () -> getChecked(FAILED_FUTURE_CHECKED_EXCEPTION, TwoArgConstructorException.class, 0, SECONDS));
