...
class RandomUtilsTest extends AbstractLangTest {
    ...
    /**
     * Provides streams of different RandomUtils implementations for parameterized tests.
     *
    ...
    class RandomBooleanTests {
        ...
        @DisplayName("should return a boolean value without error")
        void shouldReturnBooleanValue(final RandomUtils ru) {
            // This is a smoke test to ensure the method executes without error.
            // The actual randomness is not tested.
            ru.randomBoolean();
        }
    }
    ...
    class RandomDoubleTests {
        @ParameterizedTest
        @MethodSource("org.apache.commons.lang3.RandomUtilsTest#randomProvider")
        @DisplayName("should generate a value within the default range [0, Double.MAX_VALUE)")
        void shouldGenerateValueWithinDefaultRange(final RandomUtils ru) {
        ...
        @ParameterizedTest
        @MethodSource("org.apache.commons.lang3.RandomUtilsTest#randomProvider")
        @DisplayName("should generate a value within the specified range")
        void shouldGenerateValueWithinGivenRange(final RandomUtils ru) {
        ...
        @ParameterizedTest
        @MethodSource("org.apache.commons.lang3.RandomUtilsTest#randomProvider")
        @DisplayName("should generate a value within an extreme range [0, Double.MAX_VALUE)")
    ...
    class RandomFloatTests {
        @ParameterizedTest
        @MethodSource("org.apache.commons.lang3.RandomUtilsTest#randomProvider")
        @DisplayName("should generate a value within the default range [0, Float.MAX_VALUE)")
        void shouldGenerateValueWithinDefaultRange(final RandomUtils ru) {
        ...
        @ParameterizedTest
        @MethodSource("org.apache.commons.lang3.RandomUtilsTest#randomProvider")
        @DisplayName("should generate a value within an extreme range [0, Float.MAX_VALUE)")
        void shouldGenerateValueWithinExtremeRange(final RandomUtils ru) {
    ...
    class RandomIntTests {
        @ParameterizedTest
        @MethodSource("org.apache.commons.lang3.RandomUtilsTest#randomProvider")
        @DisplayName("should generate a value within the default range [0, Integer.MAX_VALUE)")
        void shouldGenerateValueWithinDefaultRange(final RandomUtils ru) {
        ...
        @ParameterizedTest
        @MethodSource("org.apache.commons.lang3.RandomUtilsTest#randomProvider")
        @DisplayName("should generate a value within an extreme range [0, Integer.MAX_VALUE)")
        void shouldGenerateValueWithinExtremeRange(final RandomUtils ru) {
    ...
    class RandomLongTests {
        @ParameterizedTest
        @MethodSource("org.apache.commons.lang3.RandomUtilsTest#randomProvider")
        @DisplayName("should generate a value within the default range [0, Long.MAX_VALUE)")
        void shouldGenerateValueWithinDefaultRange(final RandomUtils ru) {
        ...
        @ParameterizedTest
        @MethodSource("org.apache.commons.lang3.RandomUtilsTest#randomProvider")
        @DisplayName("should generate a value within an extreme range [0, Long.MAX_VALUE)")
        void shouldGenerateValueWithinExtremeRange(final RandomUtils ru) {
        ...
        /**
         * This test is for LANG-1592. It checks that for a large-valued long range,
         * the exclusive end is never returned. A previous implementation using
         * {@code (long) nextDouble(startInclusive, endExclusive)} could fail this test.
         */
        @ParameterizedTest
        @MethodSource("org.apache.commons.lang3.RandomUtilsTest#randomProvider")
        @DisplayName("should not generate the exclusive end value for a large-valued range")
        void shouldNotGenerateEndExclusiveValue_forLargeRange(final RandomUtils ru) {
            final long startInclusive = 12900000000001L;
            final long endExclusive = 12900000000016L;
            // The loop size is large because the bug was hard to reproduce.
            // This size makes failure highly likely with the old, flawed implementation.
