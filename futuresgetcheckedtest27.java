...
public class FuturesGetCheckedTestTest27 extends TestCase {
    ...
    public void testGetCheckedUntimed_exceptionClassSomePrivateConstructors() {
        assertThrows(ExceptionWithSomePrivateConstructors.class, () -> getChecked(FAILED_FUTURE_CHECKED_EXCEPTION, ExceptionWithSomePrivateConstructors.class));
    }
}
