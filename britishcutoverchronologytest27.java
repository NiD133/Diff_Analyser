...
public class BritishCutoverChronologyTestTest27 {
    ...
    public void test_atTime() {
        ...
        ChronoLocalDateTime<BritishCutoverDate> test2 = BritishCutoverChronology.INSTANCE.localDateTime(LocalDateTime.from(test));
