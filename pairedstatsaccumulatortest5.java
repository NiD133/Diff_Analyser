...
public class PairedStatsAccumulatorTestTest5 extends TestCase {
    ...
    public void testPopulationCovariance() {
        ...
        for (ManyValues values : ALL_MANY_VALUES) {
            ...
            if (values.hasAnyNonFinite()) {
                ...
                assertWithMessage("population covariance by addAll(PairedStats) of " + values).that(populationCovarianceByAddAllPartitionedPairedStats).isNaN();
            } else {
                ...
                assertWithMessage("population covariance by addAll(PairedStats) of " + values).that(populationCovarianceByAddAllPartitionedPairedStats).isWithin(ALLOWED_ERROR).of(MANY_VALUES_SUM_OF_PRODUCTS_OF_DELTAS / MANY_VALUES_COUNT);
            }
        }
